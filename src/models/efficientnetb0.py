...
def train_model(model, num_epochs=50):
    logger = Logger(log_dir="logs_efficientnetb0", class_names=class_names)
    ...
    torch.save(model.state_dict(), "best_model_efficientnetb0.pt")
    print(f"   -> En iyi model 'best_model_efficientnetb0.pt' olarak kaydedildi.\n")
...
print("\n" + "="*60)
print("TÜM İŞLEMLER BAŞARIYLA TAMAMLANDI (EfficientNet-B0)")
